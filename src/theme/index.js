export default {
	...
	"fontFamily": {
		...
		"googleArvo": "Arvo, serif",
		"googleOpenSans": "Open Sans, sans-serif"
	},
	"font": {
		"headline1": "normal bold 60px/74px --fontFamily-googleArvo",
		"headline2": "normal 500 36px/48px --fontFamily-googleArvo",
		"headline3": "normal 500 22px/32px --fontFamily-googleArvo",
		"base": "normal 500 14px/26px --fontFamily-googleArvo",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"button": "bold 12px/15px --fontFamily-googleMontserrat"
	},
	"boxShadow": {
